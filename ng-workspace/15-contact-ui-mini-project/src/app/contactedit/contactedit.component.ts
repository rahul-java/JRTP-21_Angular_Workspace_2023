...
export class ContacteditComponent {
  ...
  constructor(private contactService:ContactService, private router:Router, private activeRouter:ActivatedRoute){}
  ...
  getContact(){
    ...
    this.contactService.findContactById(this.id).subscribe(data=>{
